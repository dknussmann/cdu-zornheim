...
export function MagicLoginForm() {
  ...
  return (
    <form action={action} className="space-y-4 border border-[color:var(--cdu-blue)]/15 bg-white p-5">
      <div>
        <label htmlFor="email" className="block text-sm font-bold text-[color:var(--cdu-blue)]">
          E-Mail-Adresse
        </label>
        <input
          id="email"
          ...
          required
          autoComplete="email"
          className="mt-1 w-full rounded border border-[color:var(--cdu-blue)]/25 px-3 py-2 outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--cdu-teal)]"
